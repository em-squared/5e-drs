...
**Classe d'armure**. La **classe d'armure** d'un objet représente la difficulté qu'il y a à l'endommager en le frappant (étant donné qu'il n'a aucune chance d'éviter le coup). La table [Classe d'armure des objets](#classe-d-armure-des-objets) propose des valeurs de CA pour divers matériaux.
